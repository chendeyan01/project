...
apollo_config_db_url=jdbc:mysql://housesline.net:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=sanchong.123

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://housesline.net:3306/ApolloPortalDB?characterEncoding=utf8
apollo_portal_db_username=root
apollo_portal_db_password=sanchong.123
...
# meta server url
config_server_url=http://192.168.159.130:8080
admin_server_url=http://192.168.159.130:8090
eureka_service_url=$config_server_url/eureka/
portal_url=http://192.168.159.130:8070
