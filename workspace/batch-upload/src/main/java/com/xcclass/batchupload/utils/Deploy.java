package com.xcclass.batchupload.utils;
import java.io.*;
...
import java.util.regex.Pattern;
    ...
    public class Deploy {
        ...
        public static final String BASE_CMD = "cmd /c mvn " +
                "deploy:deploy-file " +
                "-Durl=http://10.32.85.201:8081/repository/zzdit/ " +
                "-DrepositoryId=zzdit " +
                "-DgeneratePom=false ";
        ...
        public static void main(String[] args) {
            deploy(new File("C:\\Users\\Think\\.m2\\repository\\com\\zzdit").listFiles());
//        if(checkArgs(args)){
...
//        }
        ...
        public static boolean checkArgs(String[] args){
            if (args.length != 1) {
                System.out.println("用法如： java -jar Deploy C:\\some\\path\\");
                return false;
            }
            File file = new File(args[0]);
            if (!file.exists()) {
